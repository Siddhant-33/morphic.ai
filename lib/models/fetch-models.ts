...
async function fetchNvidiaModels(): Promise<Model[]> {
  ...
  return [
    { id: "deepseek-ai/deepseek-v4-flash", name: "DeepSeek V4 Flash (Fastest NVIDIA)", provider: "NVIDIA", providerId: "nvidia" },
    { id: "minimaxai/minimax-m2.7", name: "MiniMax M2.7 (Best Overall)", provider: "NVIDIA", providerId: "nvidia" },
    { id: "glm/glm-5.1", name: "GLM-5.1 (Strong Reasoning)", provider: "NVIDIA", providerId: "nvidia" },
  ]
}
...
export async function fetchAvailableModels(): Promise<Record<string, Model[]>> {
  ...
  const allModels: Model[] = [
    ...
    // Best Gemini Models (Fast + Strong)
    { id: "gemini-3.1-flash", name: "Gemini 3.1 Flash (Fast)", provider: "Google", providerId: "google" },
    { id: "gemini-3.1-pro-preview", name: "Gemini 3.1 Pro Preview (Powerful)", provider: "Google", providerId: "google" },
